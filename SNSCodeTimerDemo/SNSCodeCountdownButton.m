...
- (void)pretreat {
    ...
    self.selectedStateImageName = @"timerBtn_imageView_highlighted";
}
...
- (void)initWithCountdownBeginNumber  {
    ...
    [self setTitle:[NSString stringWithFormat:@"还剩%zd秒",self.countdownBeginNumber - 1] forState:UIControlStateNormal];
